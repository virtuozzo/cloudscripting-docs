...
In order to get this solution instantly deployed, click the "Get It Hosted Now" button, specify your email address within the widget, choose one of the [Virtuozzo Application Platform Public Cloud providers](https://www.virtuozzo.com/application-platform-partners/) and press Install.
...
``` json
{
  ...
  "success": "Addon was successufully installed with default Virtuozzo Application Platform configuration. If you desire to set custom behaviour for your environment - please please refer to <a href='${globals.documentationLink}' target='_blank'>ducumentation</a>"
}
```
