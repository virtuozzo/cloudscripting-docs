...
You can bind your scripts to the <b>*onAfterReturn*</b> event to execute the required <a href="/1.4/creating-manifest/actions/" target="_blank">actions</a>.                


## Intercontainer Scripts
In order to execute a shell script inside of a container, use the <a href="/1.4/creating-manifest/actions/#cmd" target="_blank">ExecuteShellCommands</a> (*cmd*) action.                                              
...
Using a <a href="/1.4/creating-manifest/actions/#script" target="_blank">*script*</a> action.                  
...
- See how to create your custom <a href="/1.4/creating-manifest/addons/" target="_blank">Add-Ons</a>                                
