...
| vps, cache, build, proxysql, storage | centos-vps, ubuntu-vps, memcached-dockerized(memcached), maven(maven3), proxysql, storage, windows2008, windows2012                                                                                                                                | [Additional Stacks](https://docs.jelastic.com/software-stacks-versions#additional)   |
