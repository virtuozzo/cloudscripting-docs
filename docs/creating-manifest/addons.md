...
You can install the developed add-on either by specifying a target <a href="/1.4.2/creating-manifest/selecting-containers/#all-containers-by-group" target="blank">*nodeGroup*</a>, or by calling the <a href="/1.4.2/creating-manifest/actions/#installaddon" target="blank">*installAddon*</a> action.             
