...
- `${nodes.}`
    ...
    where:
    - `(group)` - node group (<a href="/1.3/creating-manifest/selecting-containers/#all-containers-by-group" target="_blank">nodeGroup</a> or <a href="/1.3/creating-manifest/selecting-containers/#all-containers-by-type" target="_blank">nodeType</a>)           
...
Learn more about the event placeholders within the <a href="/1.3/creating-manifest/events" target="_blank">*Events*</a> page.         
...
```
@@!
Here, the name of the placeholder is `${settings.customName}`. See the list of <a href="/1.3/creating-manifest/visual-settings/" target="_blank">fields</a> that are defined by users.       
...
- `${baseUrl}` - user custom relative URL. More details about <a href="/1.3/creating-manifest/basic-configs/#relative-links">Relative Links here</a>
...
- `(key)` - node <a href="/1.3/creating-manifest/placeholders/#node-placeholders" target="_blank">parameters</a>                            
...
Explore the full list of available <a href="/1.3/creating-manifest/selecting-containers/#all-containers-by-type" target="_blank">*nodeType*</a> values within the linked page.                                                         
...
- Check how to create your custom <a href="/1.3/creating-manifest/addons/" target="_blank">Add-Ons</a>                                         
