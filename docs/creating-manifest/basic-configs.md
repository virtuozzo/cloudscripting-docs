...
- `settings` *[optional]* - custom form with <a href="/1.5.2/creating-manifest/visual-settings/" target="_blank">predefined user input elements</a>
...
- `engine` *[optional]* - engine <a href="/1.5.2/creating-manifest/selecting-containers/#engine-versions" target="_blank">version</a>, by **default** `java6`
...
- "..." - the list of <a href="/1.5.2/creating-manifest/events/" target="_blank">events</a> can be predefined before manifest is installed. More details 
...
- `nodeType` *[required]* - the defined node type. The list of available stacks are <a href="/1.5.2/creating-manifest/selecting-containers/#supported-stacks" target="_blank">here</a>. 
...
- `script` - <a href="/1.5.2/creating-manifest/actions/#script" target="_blank">action</a>, for executing javascript and java scripts
...
The Cloud Scripting engine also supports a `${baseUrl}` placeholder. It can be used throughout the users’ customs scripts (within the <a href="/1.5.2/creating-manifest/actions/#cmd" target="_blank">*cmd*</a> and <a href="/1.5.2/creating-manifest/actions/#script" target="_blank">*script*</a> actions).                 
